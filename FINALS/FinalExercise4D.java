...
public class FinalExercise4D {
    ...
    /**
     * The balloonSortStrings method sorts the a string array c in ascending
     order following the balloon sort algorithm.
     */
    public static void balloonSortStrings(String[] c){
