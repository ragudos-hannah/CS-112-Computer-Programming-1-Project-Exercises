/**
 ...
 -----------------------------------------------------------------------------------------------------------------------
 Sorting Algorithm Type: Bubble Sort
 -----------------------------------------------------------------------------------------------------------------------
 */
...
public class FinalExercise4E {
    ...
    /**
     * The bubbleSortStrings method sorts the a string array c in ascending
     order following the bubble sort algorithm.
     */
    public static void bubbleSortStrings(String[] c){
        for(int x=0; x<c.length-1; x++){
            for(int y=0; y<c.length-1-x; y++){
                if(c[y].compareToIgnoreCase(c[y+1]) > 0){
                    String temp = c[y];
                    c[y] = c[y+1];
                    c[y+1] = temp;
                }
