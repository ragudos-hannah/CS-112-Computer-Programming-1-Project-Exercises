...
------------------------------------------------------------------------------------------------------------------------
 Sorting Algorithm Type: Balloon Sort
 -----------------------------------------------------------------------------------------------------------------------
 */
...
public class FinalExercise4A {
    ...
    public static void main(String args[]){
        ...
        double[] numberList = new double[size]; addNumbersToArray(numberList);
        System.out.println("\n\nEntered numbers are : \n" +  displayArray(numberList));
        balloonSortDesc(numberList);
        System.out.println("\n\nNumbers in descending order : \n" + displayArray(numberList));
        balloonSort(numberList);
    ...
    public static String displayArray(double[] list) {
        ...
        for(int i=0; i<size-1; i++){
            numberString.append(list[i]).append(", ");
        }
        numberString.append(list[size - 1]);
     ...
     */
    public static void balloonSortDesc(double[] i) {
     ...
     * The method sorts the a double array i in ascending order following the
     balloon sort algorithm.
     */
    public static void balloonSort(double[] i) {
        for (int x = 0; x < i.length - 1; x++) {
            for (int y = x + 1; y < i.length; y++) {
                if (i[x] > (i[y])) {
                    double dummy = i[x];
