...
// Let the program for Midterm Exercise 2B start here
...
public class MidtermExercise2B {
    public static void main(String[] args) {
        ...
        int perfectTotalQuizScore , totalQuizScore , examScore , perfectExamScore ;
        double quizGrade, examGrade, numericGrade;
        char letterGrade = 'I';
        String studentName ;
        ...
        studentName = (scan.nextLine()); // 1
        System.out.print("Enter the perfect total quiz score: ");

        perfectTotalQuizScore = Integer.parseInt(scan.nextLine()); // 2
        ...
        totalQuizScore = Integer.parseInt(scan.nextLine());
        ...
        perfectExamScore = Integer.parseInt(scan.nextLine()); // 3 perfectExamScore
        ...
        examScore = Integer.parseInt(scan.nextLine()); // 5
